    ...
    <div class="container" id="dashboard-content">
        <div class="row" id="menu">
            <div class="col-md-3">
                ...
                <div class="row">
                    <button type="button" class="btn btn-outline-light btn-dashboard-menu">
                        Images
                    </button>
                </div>
                <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="mb-3" id="searchBar">
                    <input type="text" class="form-control login-components text-white"
                    ...
                    <table class="table text-white" id="updates-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php 
                                $newFilePath = imagePathChanger($news['Image']);
                                echo "<a href = '".$newFilePath."'>".$newFilePath."</a>"; ?></td>
                                <td>
                                    <?php 
                ...
                <form action="middleware/newsHandler.php" method="POST" enctype="multipart/form-data">
                    <p class="h1 text-white text-center" id="start-form">
                        Updates Setup
                    </p>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label text-white">Update Title :</label>
                        <input type="text" class="form-control login-components text-white"
                            id="exampleFormControlInput1" placeholder="Enter the title" name="news-title" />
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label text-white">Description :</label>
                        <textarea class="form-control login-components text-white" id="exampleFormControlTextarea1"
                            rows="5" placeholder="Enter the description (max 1000 characters)"
                            name="news-description"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="formFile" class="form-label text-white">Upload your Image :</label>
                        <input class="form-control login-components text-white" type="file" id="formFile"
                            name="news-image" accept="image/*" />
                    </div>
                    <button type="submit" class="btn btn-outline-success login-btn-set" name="add">
                        Add Update
                    </button>
                    <button type="submit" class="btn btn-outline-primary login-btn-set" name="update">
                        Change Update
                    </button>
                    <button type="reset" class="btn btn-outline-secondary login-btn-set" name="clear">
                        Clear Form
                    </button>
                    <button type="submit" class="btn btn-outline-danger login-btn-set" name="delete">
                        Delete Update
                    </button>
                </form>
            </div>
